...
namespace Events.Api.IntegrationTests.Docker
{
    public class EventsContollerIT : IClassFixture<DockerWebApplicationFactory<Program>>
    {
        private readonly DockerWebApplicationFactory<Program> _factory;
        private readonly HttpClient _client;
        private readonly ITestOutputHelper _output;


        public EventsContollerIT(DockerWebApplicationFactory<Program> factory, ITestOutputHelper output)
        {
            _factory = factory;
            _output = output;
